// Generated by gencpp from file dm_motor/hdrarm_msg.msg
// DO NOT EDIT!


#ifndef DM_MOTOR_MESSAGE_HDRARM_MSG_H
#define DM_MOTOR_MESSAGE_HDRARM_MSG_H
...
struct hdrarm_msg_
{
  ...
  typedef boost::shared_ptr< ::dm_motor::hdrarm_msg_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::dm_motor::hdrarm_msg_<ContainerAllocator> const> ConstPtr;

}; // struct hdrarm_msg_

typedef ::dm_motor::hdrarm_msg_<std::allocator<void> > hdrarm_msg;

typedef boost::shared_ptr< ::dm_motor::hdrarm_msg > hdrarm_msgPtr;
typedef boost::shared_ptr< ::dm_motor::hdrarm_msg const> hdrarm_msgConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::dm_motor::hdrarm_msg_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dm_motor::hdrarm_msg_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::dm_motor::hdrarm_msg_<ContainerAllocator1> & lhs, const ::dm_motor::hdrarm_msg_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::dm_motor::hdrarm_msg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dm_motor::hdrarm_msg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dm_motor::hdrarm_msg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dm_motor::hdrarm_msg_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dm_motor::hdrarm_msg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dm_motor::hdrarm_msg_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::dm_motor::hdrarm_msg_<ContainerAllocator> >
{
  ...
  static const char* value(const ::dm_motor::hdrarm_msg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x5a62e58a22a17162ULL;
  static const uint64_t static_value2 = 0xb499a805b6b83bb9ULL;
};

template<class ContainerAllocator>
struct DataType< ::dm_motor::hdrarm_msg_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::dm_motor::hdrarm_msg_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dm_motor::hdrarm_msg_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::dm_motor::hdrarm_msg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dm_motor::hdrarm_msg_<ContainerAllocator>& v)
  {
...
#endif // DM_MOTOR_MESSAGE_HDRARM_MSG_H
